  ...
  public static void main(String... args) {
    ...
    if (args.length == 2) {
      if (args[1].contains(".csv")) {
        ...
        throw new IllegalArgumentException("File type of " + args[1] + " is not supported");
      }
    }else{
      throw new IllegalArgumentException("Expected two arguments but found " + args.length);
    }
  }
}
